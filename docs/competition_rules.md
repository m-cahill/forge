...
**[See Section 3.18 for defined terms](https://www.kaggle.com/competitions/nvidia-nemotron-model-reasoning-challenge/rules#18.-terms)**
...
2. The Competition Data is also subject to the following terms and conditions: [CC BY 4.0 License](https://creativecommons.org/licenses/by/4.0/). In accordance with these terms, any use of the Data must include an acknowledgement and attribution to the NVIDIA Research team.
...
1. Open Source: You hereby license and will license your winning Submission and the source code used to generate the Submission under an Open Source Initiative-approved license CC BY 4.0 (see [www.opensource.org](http://www.opensource.org/)) that in no event limits commercial use of such code or model containing or depending on such code.
...
3. In the event that input data or pre-trained models with an incompatible license are used to generate your winning solution, you do not need to grant an open source license in the preceding Section for that data and/or model(s).
